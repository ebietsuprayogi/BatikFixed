<?php
    ...
    $id = $_GET['id'];
	$query_mysql = mysqli_query($conn,"SELECT * FROM pria WHERE kode_brg='$id'")or die(mysql_error());
	$nomor = 1;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-30">
                        ...
                        <br>
                        <form method="post" action="../controller/ubahpria.php" enctype="multipart/form-data">
